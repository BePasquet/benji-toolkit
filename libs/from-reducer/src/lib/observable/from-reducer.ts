 ...
 * this result will become the current state that will be reduced the next time an event occur.
 *
 ...
 * will merge their results to single observable that will emit every time one of them emits calling the previous function with its result.
